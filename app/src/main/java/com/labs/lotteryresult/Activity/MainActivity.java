...
import com.labs.lotteryresult.PagerAdapter;
import com.labs.lotteryresult.Ngay;
import com.labs.lotteryresult.Tinh;
...
import static com.labs.lotteryresult.VariableStatic.lotteryResult;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addViewPager() {
        List<LotteryFragment> list = new ArrayList<LotteryFragment>();
        String[] nameTab = new String[100];

        for (int i = 0; i < 8; i++) {
            list.add(new LotteryFragment(lotteryResult.get(i).getNgay()));
            nameTab[i] = lotteryResult.get(i).getTenTinh();
        }
    ...
    private void getData() {
        lotteryResult.add(getTinhHCM());
        lotteryResult.add(getTinhCT());
        lotteryResult.add(getTinhCM());
        lotteryResult.add(getTinhBTH());
        lotteryResult.add(getTinhBP());
        lotteryResult.add(getTinhBL());
        lotteryResult.add(getTinhBD());
        lotteryResult.add(getTinhAG());
    }
